...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query_tambah = "INSERT INTO percakapan (pembuat_pesan, nama_pesan, arti, kategori_id, kapan_dibuat) VALUES ('$pembuat_pesan', '$nama_pesan', '$arti', $kategori, NOW())";
    ...
    <div class="container">
        <div class="chat-container">
            ...
            <form action="" method="POST">
                ...
                <div class="form-group-1">
                    <h5 for="arti">Terjemahan:</h5>
                    <textarea class="form-control" id="arti" name="arti" rows="3" placeholder="Tulis pesan Anda" required></textarea>
                </div>
                <div class="form-group-1">
                    ...
                    <?php if (count($percakapan) > 0) : ?>
                        ...
                        percakapan.forEach(function(pc, index) {
                            if (pc.kategori_id == selectedKategori) {
                                ...
                                // Arti pesan (terjemahan)
                                var artiPesan = document.createElement('p');
                                artiPesan.classList.add('arti-pesan'); // Tambahkan kelas CSS untuk gaya terjemahan
                                artiPesan.innerText = "Terjemahan: " + pc.arti;

                                // Tambahkan elemen-elemen ke dalam chatBubble
                                chatBubble.appendChild(pembuatPesan);
                                chatBubble.appendChild(namaPesan);
                                chatBubble.appendChild(artiPesan); // Tambahkan terjemahan di sini
                                ...
                                // Tambahkan chatBubble dan chatMeta ke dalam chatItem
                                chatItem.appendChild(chatBubble);
                                chatItem.appendChild(chatMeta);

                                // Tambahkan chatItem ke dalam chatList
