...
<main>
    <a href="tambah_level_menulis.php" style="color:white; text-decoration:none" id="tambahLevelLink">
        <button class="btn-tambah-lvl">Tambah level</button>
    </a>
    <div id="popup1" class="popup">
        <div class="popup-content">
            <span class="close" id="close1">&times;</span>
            <iframe src="tambah_level_menulis.php" width="100%" height="400px"></iframe>
        </div>
    </div>

    <a href="tambah_task_menulis.php" style="color:white; text-decoration:none" id="tambahTaskLink">
        <button class="btn-tambah-lvl">Tambah task</button>
    </a>
    <div id="popup2" class="popup">
        <div class="popup-content">
            <span class="close" id="close2">&times;</span>
            <iframe src="tambah_task_menulis.php" width="100%" height="400px"></iframe>
        </div>
    </div>
    <!-- Pop-up untuk Edit -->
    ...
    <script>
        ...
        function openEditPopup(id) {
            document.getElementById('editFrame').src = 'edit_menulis.php?id=' + id;
...
$query = "SELECT id_level, gambar, level FROM gambar_menulis";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<a href="delete.php?id=' . $row['id_level'] . '&tabel=menulis" class="delete_button" onclick="return confirm(\'Anda yakin ingin menghapus tugas ini?\')">Delete</a>';
        echo '</div>';
    }
