...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($foto_tmp, $targetFile)) {
            ...
            $sql = "INSERT INTO task_membaca (id_level,nama,gambar,jawaban_benar,jawaban_salah1,jawaban_salah2,jawaban_salah3)
            VALUES ('$id_level','$nama','$foto_unique','$jawaban_benar','$jawaban_salah1','$jawaban_salah2','$jawaban_salah3')";
