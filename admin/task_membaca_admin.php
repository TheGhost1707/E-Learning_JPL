...
<main>
    ...
    <?php
    // Kode PHP untuk mengambil data dari database tetap sama
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<a href="delete.php?id=' . $row['id_level'] . '&tabel=membaca" class="delete_button" onclick="return confirm(\'Anda yakin ingin menghapus tugas ini?\')">Delete</a>';
            echo '</div>';
        }
