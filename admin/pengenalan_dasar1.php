    ...
    <main>
        ...
        <div id="popup1" class="popup">
            <div class="popup-content">
                ...
                <iframe src="tambah_pengenalan1.php" width="100%" height="400px"></iframe>
            </div>
        </div>
        <div class="title-pembelajaran">
            <h1>Pengenalan nama buah</h1>
            <hr>
        ...
        <div class="content-pembelajaran">
            ...
            $sql = "SELECT*FROM pengenalan_dasar1 where kategori='buah'";
            $result = $koneksi->query($sql);
            ...
            ?>
                    <a href="#" style="color:black; text-decoration:none;">
                        <div class="box-container">
                            ...
                            <p style="text-align:center; font-weight:bold;"><?php echo htmlspecialchars($row['arti_huruf']); ?></p>
                            <a href="#" class="edit_button" id="<?php echo $row['id_pengenalan']; ?>">Edit</a>
                            <a href="delete_pengenalan1.php?id=<?php echo $row['id_pengenalan']; ?>" class="delete_button" onclick="return confirm('Anda yakin ingin menghapus pembelajaran ini?')">Delete</a>
        ...
        <div class="title-pembelajaran">
            <h1>Pengenalan nama anggota keluarga</h1>
            <hr>
        ...
        <div class="content-pembelajaran">
            ...
            include 'koneksi.php';
            // Query untuk mengambil data dari tabel
            $sql = "SELECT*FROM pengenalan_dasar1 where kategori='keluarga'";
            $result = $koneksi->query($sql);
        ...
        <div class="title-pembelajaran">
            <h1>Pengenalan nama kendaraan</h1>
            <hr>
        ...
        <div class="content-pembelajaran">
            ...
            include 'koneksi.php';
            // Query untuk mengambil data dari tabel
            $sql = "SELECT*FROM pengenalan_dasar1 where kategori='kendaraan'";
            $result = $koneksi->query($sql);
        ...
        <div class="content-pembelajaran">
            ...
            include 'koneksi.php';
            // Query untuk mengambil data dari tabel
            $sql = "SELECT*FROM pengenalan_dasar1 where kategori='hewan'";
            $result = $koneksi->query($sql);
        ...
        <script>
            ...
            editButtons.forEach(function(button) {
                button.onclick = function(event) {
                    ...
                    editIframe.src = 'edit_pengenalan1.php?id=' + idPengenalan;
