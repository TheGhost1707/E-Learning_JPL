...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE pengenalan_dasar1 SET huruf_jepang = '$huruf_jepang', arti_huruf = '$arti_huruf'";
                ...
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            $sql = "SELECT * FROM pengenalan_dasar1 WHERE id_pengenalan = $id_pengenalan";
