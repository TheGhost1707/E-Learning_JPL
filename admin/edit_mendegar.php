...
$id_level = $_GET['id'];
$query = "SELECT * FROM gambar_mendengar WHERE id_level = $id_level";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($gambar['name']) {
        ...
        if (move_uploaded_file($foto_tmp, $target_file)) {
            ...
            $query_select_old = "SELECT gambar FROM gambar_mendengar WHERE id_level = $id_level";
            ...
            $query_update = "UPDATE gambar_mendengar SET level = '$level', gambar = '$foto_unique' WHERE id_level = $id_level";
        ...
        $query_update = "UPDATE gambar_mendengar SET level = '$level' WHERE id_level = $id_level";
        if (mysqli_query($koneksi, $query_update)) {
