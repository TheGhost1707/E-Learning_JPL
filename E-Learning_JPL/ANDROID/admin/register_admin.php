...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($check_username) > 0) {
        ...
        header("location: register_admin.php?pesan=username_exists");
        exit;
    }
...
<head>
    ...
    <title>Register - E-learning Japanese Language</title>
                            ...
                            <form action="" method="POST" enctype="multipart/form-data" id="registerForm">
                                ...
                                <div class="form-group">
                                    <select class="form-control" id="role" name="role" required>
                                        ...
                                        <option value="Admin">Admin E-learning JPL</option>
                                    </select>
                                </div>
