...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $jenis_task = $koneksi->real_escape_string($_POST['jenis_task']);
    $nama = $koneksi->real_escape_string($_POST['nama']);
    $gambar = $_FILES['gambar'];
    $jawaban_benar = $koneksi->real_escape_string($_POST['jawaban_benar']);
    $jawaban_salah1 = $koneksi->real_escape_string($_POST['jawaban_salah1']);
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($foto_tmp, $targetFile)) {
            ...
            $sql = "INSERT INTO task_membaca (id_level,jenis_task,nama,gambar,jawaban_benar,jawaban_salah1,jawaban_salah2,jawaban_salah3)
            VALUES ('$id_level','$jenis_task','$nama','$foto_unique','$jawaban_benar','$jawaban_salah1','$jawaban_salah2','$jawaban_salah3')";
                        ...
                        <div class="col-md-8">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <select class="form-control" id="id_level" name="id_level" required>
                                    ...
                                    $sql = "SELECT gambar_membaca.id_level, gambar_membaca.level 
                                    FROM gambar_membaca";
                                ...
                                <div class="form-group first">
                                    <label for="level" style="font-size:20px;">Jenis Task</label>
                                    <input type="text" class="form-control" id="jenis-task" name="jenis_task" required>
                                </div>
                                <div class="form-group first">
                                ...
                                <div class="form-group first">
                                    <label for="jawaban_salah1" style="font-size:20px;">Jawaban Salah 1</label>
                                    <input type="text" class="form-control" id="jawaban_salah1" name="jawaban_salah1" required>
                                </div>
                                <div class="form-group first">
                                    <label for="jawaban_salah2" style="font-size:20px;">Jawaban Salah 2</label>
                                    <input type="text" class="form-control" id="jawaban_salah2" name="jawaban_salah2" required>
                                </div>
                                <div class="form-group first">
                                    <label for="jawaban_salah3" style="font-size:20px;">Jawaban Salah 3</label>
                                    <input type="text" class="form-control" id="jawaban_salah3" name="jawaban_salah3" required>
                                </div>
